...
Invoke-RestMethod -Method Post -Uri "$BaseUrl/api/recovery/rebuild" -Headers @{ "X-Gcor-Webhook-Secret" = $Secret } -ContentType "application/json" -Body $body | ConvertTo-Json -Depth 8
